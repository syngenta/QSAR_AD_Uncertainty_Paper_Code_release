...
from perform_regression_modelling_on_exemplar_endpoints import get_nested_dicts_of_modelling_results_for_all_exemplar_endpoints as get_nested_dicts_of_modelling_results_for_all_other_endpoints
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Specify period (".") list of endpoints to generate results for in case running all endpoints at once takes too long.')
    ...
    for dataset_name in regression_dataset_names:
        ...
        dict_of_raw_results, dict_of_stats, statsFilesDict = get_nested_dicts_of_modelling_results_for_all_other_endpoints(endpoints_of_interest,dataset_name, dict_of_stats, statsFilesDict, dict_of_raw_results, ds_matched_to_other_endpoints_not_in_exemplar_endpoints_list, selected_uncertainty_methods, selected_ad_methods, all_global_random_seed_opts, consistent_id_col,   consistent_act_col, dir_with_files_to_parse, top_calc_dir)
